...
// Un bucle que se ejecuta 31 veces para la secuencia de 500
for (let i = 0; i < 31; i++) {
...
// Un bucle que se ejecuta 30 veces para la secuencia de 456
for (let i = 0; i < 30; i++) {
    // Acumulamos el valor actual antes de actualizar la secuencia
...
console.log(`La suma de ambos es: ${sumatotal}`); // Suma total: 32562
